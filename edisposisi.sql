...
INSERT INTO `log_surat` (`id_log_surat`, `id_surat`, `waktu`, `aksi`, `id_bidang`, `memo`) VALUES
...
(22, 'weui', '2018-09-13', 'rfghjlg', 'qwertyui', 'README.md', 'kb', 12, 2, 'n', 'd'),
...
--
ALTER TABLE `log_surat`
  MODIFY `id_log_surat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
